...
export class VideoPlayer
{
    ...
    {
        const entities = await this.engineAPI.filterEntities({ mandatoryComponents: [ 'debug_name' ] });
    ...
    async initialize(canvas, container)
    {
        ...
        SDK3DVerse.engineAPI.setEntityVisibility(this.playerEntity, false);
        SDK3DVerse.engineAPI.setEntityVisibility(this.playerEntity, true);
        ...
        for (const screenEntity of screens)
        {
            ...
            //videoElement.geometries = videoElement.
            console.log(videoElement, children, videoElement.geometries)
    ...
    createVideoElement(id, globalTransform)
    {
        ...
        let array = globalTransform.position;
        // Add an offset of 0.5 to every value in the array so they can be in the center
        array[0] *= 2;
        array[1] *= 2;
        //array[2] += array[2]*0.5;
        object.position.fromArray(array);
